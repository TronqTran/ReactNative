...
const Todos = ({ navigation, route }) => {
  ...
  useEffect(() => {
    fetch("https://65485abedd8ebcd4ab22c6b9.mockapi.io/todo")
  ...
  const handleSaveClick = (itemId) => {
    ...
    fetch(`https://65485abedd8ebcd4ab22c6b9.mockapi.io/todo/${itemId}`, {
      method: "PUT",
      headers: {
          ...
          <View key={item.id} style={styles.viewbox1}>
            <View style={styles.viewbox5}>
              <Pressable
                onPress={() => {
                  fetch(
                    `https://65485abedd8ebcd4ab22c6b9.mockapi.io/todo/${item.id}`,
                    {
                      method: "DELETE",
                    }
                  ).then(() => {
